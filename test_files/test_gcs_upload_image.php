...
// Create a test image file to upload (PNG format)
echo "<h2>Creating Test Image File</h2>";
$testFileName = 'test_upload_' . time() . '.png';
...
if (file_exists($testFilePath)) {
    echo "<p style='color: green;'>✓ Test image file created: $testFilePath</p>";
...
try {
    ...
    if ($result['success']) {
        echo "<p style='color: green;'>✓ Image file uploaded successfully</p>";
        ...
        echo "<p style='color: red;'>✗ Image file upload failed: " . htmlspecialchars($result['error']) . "</p>";
    }
} catch (Exception $e) {
