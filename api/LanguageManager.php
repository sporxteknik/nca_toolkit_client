    ...
    public function __construct() {
        ...
        $this->translations = [
            'en' => [
                ...
                'video_cut_segments_param' => 'Segments: Specify multiple start and end times in HH:MM:SS format. Each segment will be kept in the output video.',
                ...
                'video_cut_tips_2' => 'Enter start and end times in HH:MM:SS format',
                ...
                'video_split_segments_param' => 'Segments: Specify multiple start and end times in HH:MM:SS format. The video will be split into separate files based on these times.',
                ...
                'video_split_tips_2' => 'Enter start and end times in HH:MM:SS format',
            ...
            'tr' => [
                ...
                'video_cut_segments_param' => 'Segmentler: HH:MM:SS formatında birden fazla başlangıç ve bitiş zamanı belirtin. Her segment çıktı videosunda tutulacak.',
                ...
                'video_cut_tips_2' => 'HH:MM:SS formatında başlangıç ve bitiş zamanlarını girin',
                ...
                'video_split_segments_param' => 'Segmentler: HH:MM:SS formatında başlangıç ve bitiş zamanlarını belirtin. Video bu zamanlara göre ayrı dosyalara bölünecektir.',
                ...
                'video_split_tips_2' => 'HH:MM:SS formatında başlangıç ve bitiş zamanlarını girin',
